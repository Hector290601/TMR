...
\begin{DoxyItemize}
\item \href{mailto:pumasautomodelcar@gmail.com}{\texttt{ Offficial Mail}}
\item \href{mailto:robletes062901@gmail.com}{\texttt{ Hector Robles}}
\end{DoxyItemize}

Or anyother mail in our github\textquotesingle{}s profiles. You can check our porpouse on the following presentation. $<$iframe src=\char`\"{}https\+://docs.\+google.\+com/presentation/d/e/2\+PACX-\/1v\+Sj9\+YTXaojk\+Pzc\+QOf\+L-\/8\+Ty\+Mm\+TMtz\+J04-\/\+P1f\+Ge\+St\+NJMkl2im\+KWvj\+CU\+\_\+s\+Jm\+CA23\+A\+\_\+\+Dyrqo8bxc\+Ckdcvh5/embed?start=false\&loop=true\&delayms=5000\char`\"{} frameborder=\char`\"{}0\char`\"{} width=\char`\"{}960\char`\"{} height=\char`\"{}569\char`\"{} allowfullscreen=\char`\"{}true\char`\"{} mozallowfullscreen=\char`\"{}true\char`\"{} webkitallowfullscreen=\char`\"{}true\char`\"{}$>$$<$/iframe$>$
