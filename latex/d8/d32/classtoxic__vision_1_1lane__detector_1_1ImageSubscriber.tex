...
\DoxyCodeLine{149                   print(colorsh.shape)}
\DoxyCodeLine{150                   print(colorsh)}
\DoxyCodeLine{151                   \textcolor{keywordflow}{for} row \textcolor{keywordflow}{in} colorsh:}
\DoxyCodeLine{152                       \textcolor{keywordflow}{for} col \textcolor{keywordflow}{in} row:}
\DoxyCodeLine{153                           print(col)}
\DoxyCodeLine{154                   \textcolor{comment}{\#frame = cv2.rectangle(frame, (roi\_left, roi\_upper), (roi\_right, roi\_lower), (255, 0, 0), 0)}}
...
\DoxyCodeLine{199 \textcolor{stringliteral}{              try:}}
\DoxyCodeLine{200 \textcolor{stringliteral}{                  x1, y1, x2, y2 = self.two\_dots\_line(average\_rho\_left, average\_theta\_left, frame)}}
\DoxyCodeLine{201 \textcolor{stringliteral}{                  x3 = x1 + delta}}
\DoxyCodeLine{202 \textcolor{stringliteral}{                  x4 = x1 -\/ delta}}
\DoxyCodeLine{203 \textcolor{stringliteral}{                  x5 = x2 + delta}}
\DoxyCodeLine{204 \textcolor{stringliteral}{                  x6 = x2 -\/ delta}}
\DoxyCodeLine{205 \textcolor{stringliteral}{                  cv2.line(frame, (x1, y1), (x2, y2), (255,0,0), 3, cv2.LINE\_AA)}}
\DoxyCodeLine{206 \textcolor{stringliteral}{              except:}}
\DoxyCodeLine{207 \textcolor{stringliteral}{                  pass}}
...
\DoxyCodeLine{218 \textcolor{stringliteral}{              try:}}
\DoxyCodeLine{219 \textcolor{stringliteral}{                  x1, y1, x2, y2 = self.two\_dots\_line(average\_rho\_right, average\_theta\_right, frame)}}
\DoxyCodeLine{220 \textcolor{stringliteral}{                  x3 = x1 + delta}}
\DoxyCodeLine{221 \textcolor{stringliteral}{                  x4 = x1 -\/ delta}}
\DoxyCodeLine{222 \textcolor{stringliteral}{                  x5 = x2 + delta}}
\DoxyCodeLine{223 \textcolor{stringliteral}{                  x6 = x2 -\/ delta}}
\DoxyCodeLine{224 \textcolor{stringliteral}{                  cv2.line(frame, (x1, y1), (x2, y2), (0,0,255), 3, cv2.LINE\_AA)}}
\DoxyCodeLine{225 \textcolor{stringliteral}{              except:}}
\DoxyCodeLine{226 \textcolor{stringliteral}{                  pass}}
...
\DoxyCodeLine{247     \textcolor{comment}{\#cv2.imshow("{}camera"{}, frame)}}
\DoxyCodeLine{248     \textcolor{comment}{\#cv2.imshow("{}band\_filter"{}, band\_pass)}}
\DoxyCodeLine{249     \textcolor{comment}{\#cv2.imshow("{}dst"{}, dst)}}
\DoxyCodeLine{250     \textcolor{comment}{\#cv2.setMouseCallback("{}camera"{}, mouse\_callback)}}
\DoxyCodeLine{251     \textcolor{comment}{\#cv2.setMouseCallback("{}dst"{}, mouse\_callback)}}
\DoxyCodeLine{252     \textcolor{comment}{\#cv2.setMouseCallback("{}band\_filter"{}, mouse\_callback)}}
\DoxyCodeLine{253     \textcolor{comment}{\#cv2.waitKey(1)}}
