...
drive_base_msgs__msg__TRVCommand__create()
{
  ...
  drive_base_msgs__msg__TRVCommand * msg = (drive_base_msgs__msg__TRVCommand *)allocator.allocate(sizeof(drive_base_msgs__msg__TRVCommand), allocator.state);
  if (!msg) {
    return NULL;
  }
...
drive_base_msgs__msg__TRVCommand__Sequence__init(drive_base_msgs__msg__TRVCommand__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (drive_base_msgs__msg__TRVCommand *)allocator.zero_allocate(size, sizeof(drive_base_msgs__msg__TRVCommand), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  drive_base_msgs__msg__TRVCommand__Sequence * array = (drive_base_msgs__msg__TRVCommand__Sequence *)allocator.allocate(sizeof(drive_base_msgs__msg__TRVCommand__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  drive_base_msgs__msg__TRVCommand__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    drive_base_msgs__msg__TRVCommand * data =
      (drive_base_msgs__msg__TRVCommand *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!drive_base_msgs__msg__TRVCommand__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          drive_base_msgs__msg__TRVCommand__fini(&output->data[i]);
        }
        return false;
      }
    }
